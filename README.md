...
Nota Técnica: A organização do repositório foi baseada no princípio de Separação de Responsabilidades (SoC), garantindo um software desacoplado e de fácil manutenção conforme as melhores práticas de mercado.
